...
def output_energy_gen(input_value):
    if input_value != 0:
        return 'The average installation cost of a {:.0f} kW system in Alberta is between ${:.2f} and ${:.2f}. You can expect about {:.0f} kWh of energy production from this system.'.format(input_value, input_value*1000*2.51, input_value*1000*2.77, input_value*1276)
